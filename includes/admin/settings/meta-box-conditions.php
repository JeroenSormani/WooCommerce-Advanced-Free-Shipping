		...
		foreach ( $conditions as $condition_group => $conditions ) :
			...
			<div class='condition-group condition-group-<?php echo $condition_group; ?>' data-group='<?php echo $condition_group; ?>'>
				...
				foreach ( $conditions as $condition_id => $condition ) :
					...
					// Child conditions
					if ( isset( $condition['child_conditions'] ) ) :
						foreach ( $condition['child_conditions'] as $child_id => $child_condition ) :

							@new Wafs_Child_Condition( 
								$condition_id, $child_id, $condition_group, 
								$child_condition['condition'], $child_condition['operator'], $child_condition['value'], $condition
							);
